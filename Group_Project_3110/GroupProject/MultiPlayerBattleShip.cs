...
namespace Module8
{
    internal class MultiPlayerBattleShip
    {
        ...
        private List<Grid> _playerGrids = new List<Grid>(); // TSing build error for null
        private List<Ships> _playerShips = new List<Ships>(); // TSing build error for null
        private List<IPlayer> currentPlayers = new List<IPlayer>(); // TSing build error for null
